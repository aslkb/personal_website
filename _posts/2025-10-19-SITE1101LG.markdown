...
---
This was my first project at ADA where me and my team builded 3 basic logic gates (AND,OR,NOT), and collaborated with other teams to build NAND and XOR. You can watch video about this project [here](https://www.youtube.com/watch?v=HMqk8mzw3Ew)
